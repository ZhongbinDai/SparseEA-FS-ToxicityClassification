...
for i = 1 : maxGeneration
    ...
    [newPopulation] = model.variation(population, popFitness, model);
...
%% 结果出图
pngName = sprintf('%s_%s_N%d_Gen%d.png', 'SparseEA', 'FsData5', populationSize, maxGeneration);
dataSetPath = '..\Result\';
